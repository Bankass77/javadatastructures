package javadatastructures.algorithms.string;
...
public class MultilineDemo {
	...
	public static void main(String[] args) {
		...
		String multilineStr= "line one of the text block"+ newLine+ "line two of the text block"+ newLine+ "last line of the text block";
	...
	// or method 3 using `String.join` utility method 
	   multilineStr= String.join("line one of the text block", newLine, "line two of the text block", newLine," last  line of the text block");
	   
	// or method 4 using a StringBuffer instance
	   
	   multilineStr=new StringBuffer("line one of the text block").append(newLine).append("last line of the text block").toString();
	// or method 5 using a StringBuilder instance
	   multilineStr= new StringBuilder("line one of the text block ").append(newLine).append("line two of the text block").append(newLine).toString();
